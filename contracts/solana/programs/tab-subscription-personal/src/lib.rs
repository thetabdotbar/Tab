...
declare_id!("DpQSpSdnwRB1p7iK1b5TbL1F5YqtimGd9g32jWc4WyB7");

pub const BPS_DENOMINATOR: u64 = 10_000;
// Personal-tier program: hard cap fee at zero so the admin can never
// accidentally flip the personal subscription router to a non-zero fee.
// Business-tier program at `tab-subscription` keeps the 500 bps cap.
...
#[program]
pub mod tab_subscription_personal {
    use super::*;
